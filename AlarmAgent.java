...
//      heartbeatThread.setDaemon(true);
  ...
  public void sendAlarm(String message, final long timeOut) throws InterruptedException {
  ...
  class HeartbeartThread extends Thread {
    ...
    public void run() {
      try {
        ...
        Thread.sleep(1000);
        while (true) {
          System.out.println("check connect information, check connect information!");
          if (checkConnection()) {
              connectedToServer = true;
          } else {
